...
public final class NeuralEntrainmentConversation extends FeatureConversation<NeuralEntrainmentChunk> {
    ...
    // public MergedEncodedHistory(int batchSize, int sequenceLength, int
    // embeddingSize, float[][][] encodedHistory,
    ...
    // public static MergedEncodedHistory padAndMergeEncodedHistory(final
    // NeuralEntrainmentConversation[] conversations)
    // throws Exception {
    ...
    // final float mergedHistory[][][] = new float[batchSize][sequenceLength +
    // PADDING][encodedDim];
    ...
    // return new MergedEncodedHistory(batchSize, sequenceLength, encodedDim,
    // mergedHistory, mergedHistoryLengths,
    // conversations);
    // }

    // public static void updateEncodedHistory(MergedEncodedHistory
    // mergedEncodedHistory) {
